    ...
    <section id='about'>
      ...
      <div className='container about__container'>
        ...
        <div className='about__content'>
          ...
          <motion.p variants={showFromTopVariants(200,0.8)} initial="hidden" whileInView="visible" viewport={{once:true}}>
            My name is Andrew, and I'm passionate about creating exceptional digital experiences. With over five years of experience as a front-end developer, I have the privilege of working on the cutting edge of the web, shaping the digital future.
          </motion.p>
